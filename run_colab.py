...
os.environ.setdefault("FULL954_CACHE_NAME", "embedding_cache_full954_v4_corrected_public.npz")
os.environ.setdefault("SOURCE_FULL954_CACHE_NAME", "embedding_cache_full954_v3.npz")
os.environ.setdefault("RUN_PUBLIC_DATAPREP", "1")
os.environ.setdefault("RUN_PUBLIC_CACHE_MIGRATION", "1")
os.environ.setdefault("FORCE_DATAPREP", "1")
os.environ.setdefault("FORCE_PUBLIC_EXPAND", "1")
os.environ.setdefault("EXCLUDE_WOODAUTH", "1")
os.environ.setdefault("APPLY_FSDM41_CORRECTION", "1")
...
os.environ.setdefault("RUN_SCURD_TRAINING_ABLATION", "1")
os.environ.setdefault("RUN_OOD_WITHIN_SOURCE", "1")
os.environ.setdefault("RUN_CLASS_GEOMETRY", "1")
os.environ.setdefault("RUN_SUPCON_SEED_SENSITIVITY", "0")
